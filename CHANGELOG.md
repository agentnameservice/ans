...
## [0.2.0](https://github.com/agentnameservice/ans/compare/v0.1.6...v0.2.0) (2026-09-10)
...
* **ans-verify:** verify attested metadata hashes against the served descriptor ([#112](https://github.com/agentnameservice/ans/issues/112)) ([3504947](https://github.com/agentnameservice/ans/commit/350494779f5bef53c196f335adf92c77c927eb8d)), closes [#99](https://github.com/agentnameservice/ans/issues/99)
...
* **dns:** compare SVCB TargetName as effective target, not presentation string ([#108](https://github.com/agentnameservice/ans/issues/108)) ([f6a3fee](https://github.com/agentnameservice/ans/commit/f6a3fee459fc4fa35cf5ad7cef8dedc4b2de54d3))
* **dns:** match the HTTPS record by SvcParam subset, with alpn as a list ([#116](https://github.com/agentnameservice/ans/issues/116)) ([92b5760](https://github.com/agentnameservice/ans/commit/92b5760d59dabbdffbb1692be6436df90e52bc21))
* **dns:** split alpn on the escape form that actually reaches the verifier ([#118](https://github.com/agentnameservice/ans/issues/118)) ([83875d0](https://github.com/agentnameservice/ans/commit/83875d0572287821489c8dc5fc9cf37142ee35f0))
...
* **ra:** attest only the DNS records verification actually found ([#106](https://github.com/agentnameservice/ans/issues/106)) ([2c4a1de](https://github.com/agentnameservice/ans/commit/2c4a1dea8688f5b6d569d38d2a7be38455ca348f))
